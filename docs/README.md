...
- Current release: [v0.3.0 Source Turn 与 Turn-first Task](RELEASES/v0.3.0.md)
- Release verification: [v0.3.0 发布验证记录](TESTS/v0.3.0-verification.md)
- Ground Truth rerun: [真实 Task Ground Truth 评测 v0.2](TESTS/real-task-ground-truth-eval-v0.2.md)
- Readiness: [PRD Review v0.1](REVIEWS/prd-review-v0.1.md)
- Analysis readiness: [PRD v0.3 Review](REVIEWS/prd-review-v0.3.md)
- Current analysis backlog: [PRD v0.3 Issue Publish Result](ISSUES/issue-publish-result-v0.3.md)
- Original backlog: [Published Issue Backlog v0.1](ISSUES/issue-publish-result-v0.1.md)
...
- Current implementation plan: [Codex 日报渐进分析 v0.2](../plans/codex-progressive-analysis-v0.2.md)
